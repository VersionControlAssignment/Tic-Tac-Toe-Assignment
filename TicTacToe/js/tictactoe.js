...
function placeXOrO(squareNumber) {
    ...
    //This function rersults in a random square being selected by the computer.
...
function checkWinConditions() {
    ...
    // X 0, 4, 8 condition.
    else if (arrayIncludes('0X', '4X', '85X')) { drawWinLine(100, 100, 520, 520) }
    // O 0, 1, 2 condition.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    //This line gives us sccess to methods and properties to use on canvas.
...
function resetGame() {
    ...
    for (let i = 0; i < 9; i++) {
        //This variable gets the HTML elemnt i.
